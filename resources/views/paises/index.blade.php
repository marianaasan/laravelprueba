...
<div class="right_col" role="main">
  <div class="">
      ...
      <div align="left">
		...
		<a href="{{route('escuela.paises.create')}}">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                
                  <div class="x_content">                
                    ...
                    <table id="tablaPaises" class="table table-ligth table-hover">
                      <thead>
                        <tr>
	                     ...
	                     @foreach($paises as  $pa)
                            ...
                            <td align="center">{{$pa->nombre_pais}}</td>      
	                          <td align="center">
	                           ...
	                           <a href="{{route('escuela.paises.show',$pa->id_pais)}}" class="btn btn-success btn-sm"><i class="fas fa-eye" aria-hidden="true"></i></a>
	                          </td>
	                        </tr>
	                     @endforeach                                
